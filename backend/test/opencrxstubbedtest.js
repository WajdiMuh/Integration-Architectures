...
describe("opencrx",() => {
    describe("isnotstubbed",function() {
        before(()=>{
            this.readallcustomers = sinon.stub(opencrx,'readallcustomers').callsFake(function(req,res) {
                res.send([
            ...
            this.readcustomer = sinon.stub(opencrx,'readcustomer').callsFake(function(req,res) {
                if(req.params.id == "97NB4O91UQORTH2MA4T2TYJFL"){
                    res.send(new Customer('Telekom AG','97NB4O91UQORTH2MA4T2TYJFL',4));
                }else{
                    res.send("not found")
                }
            });

            this.readallproducts = sinon.stub(opencrx,'readallproducts').callsFake(function(req,res) {
                res.send([
            ...
            this.readproduct = sinon.stub(opencrx,'readproduct').callsFake(function(req,res) {
                if(req.params.id == "9JMBMVTX2CSMHH2MA4T2TYJFL"){
                    res.send(new Product('9JMBMVTX2CSMHH2MA4T2TYJFL',1002,'HooverClean',0));
                }else{
                    res.send("not found")
                }
            });

            this.readallsales = sinon.stub(opencrx,'readallsales').callsFake(function(req,res) {
                res.send([
            ...
            this.readsale = sinon.stub(opencrx,'readsale').callsFake(function(req,res) {
                if(req.params.id == "9DTSXR06DLHPM0EBHQA5MAZ7J"){
                    res.send(new SalesOrder("9DTSXR06DLHPM0EBHQA5MAZ7J","Telekom_Sallinger_2019","07/01/2020","5500.000000000","467.500000000","5967.500000000",new Customer("Telekom AG","97NB4O91UQORTH2MA4T2TYJFL",4),new Employee("Mary-Ann Sallinger","0","90124","Senior Salesman","Sales"),[new Product("9JMBMVTX2CSMHH2MA4T2TYJFL",1002,"HooverClean",10),new Product("L6K68IE1QROBTH2MA4T2TYJFL",1001,"HooverGo",15)]));
                }else{
                    res.send("not found")
                }
            });

            this.readsalesbyemployee = sinon.stub(opencrx,'readsalesbyemployee').callsFake(function(req,res) {
                if(req.params.id == "90124"){
                    res.send([
                        new SalesOrder("9DTSXR06DLHPM0EBHQA5MAZ7J","Telekom_Sallinger_2019","07/01/2020","5500.000000000","467.500000000","5967.500000000",new Customer("Telekom AG","97NB4O91UQORTH2MA4T2TYJFL",4),new Employee("Mary-Ann Sallinger","0","90124","Senior Salesman","Sales"),[new Product("9JMBMVTX2CSMHH2MA4T2TYJFL",1002,"HooverClean",10),new Product("L6K68IE1QROBTH2MA4T2TYJFL",1001,"HooverGo",15)]),
                        new SalesOrder("9NWI6UYX6YGH87IGMO3WKDQ7W","Sausage Test 2","12/02/2022","5570.000000000","473.450000000","6043.450000000",new Customer("Germania GmbH","9DXSJ5D62FBHLH2MA4T2TYJFL",2),new Employee("Mary-Ann Sallinger","0","90124","Senior Salesman","Sales"),[new Product("9JMBMVTX2CSMHH2MA4T2TYJFL",1002,"HooverClean",30),new Product("L6K68IE1QROBTH2MA4T2TYJFL",1001,"HooverGo",44)]),
                        new SalesOrder("L6K69EO6Y3ZS9H2MA4T2TYJFL","Mayer1","26/05/2019","2200.000000000","187.000000000","2387.000000000",new Customer("Mayer Werft AG","9K9OSN1V4YY95H2MA4T2TYJFL",3),new Employee("Mary-Ann Sallinger","0","90124","Senior Salesman","Sales"),[new Product("L6K68IE1QROBTH2MA4T2TYJFL",1001,"HooverGo",10)])
            ...
            this.readsalesbyemployeeinyear = sinon.stub(opencrx,'readsalesbyemployeeinyear').callsFake(function(req,res) {
                if(req.params.id == "90124" && req.params.year == "2022"){
                    res.send([
                        new SalesOrder("9NWI6UYX6YGH87IGMO3WKDQ7W","Sausage Test 2","12/02/2022","5570.000000000","473.450000000","6043.450000000",new Customer("Germania GmbH","9DXSJ5D62FBHLH2MA4T2TYJFL",2),new Employee("Mary-Ann Sallinger","0","90124","Senior Salesman","Sales"),[new Product("9JMBMVTX2CSMHH2MA4T2TYJFL",1002,"HooverClean",30),new Product("L6K68IE1QROBTH2MA4T2TYJFL",1001,"HooverGo",44)])
                    ]);
                }else{
        ...
        after(()=>{
            opencrx.readallcustomers.restore();
            opencrx.readcustomer.restore();
            opencrx.readallproducts.restore();
            opencrx.readproduct.restore();
            opencrx.readallsales.restore();
            opencrx.readsalesbyemployee.restore();
            opencrx.readsalesbyemployeeinyear.restore();
        });
